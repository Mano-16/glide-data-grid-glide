...
import { direction, convertToStringArray, getGroupLevelIndexFromRow } from "../../../common/utils.js";
...
export function drawTextCell(
    ...
    if (data.length > 0) {
        ...
        if (!allowWrapping) {
            ...
            actualHeight =  drawMultiLineText(ctx, data, x, y, w, h, bias, theme, contentAlign, hyperWrapping, underline);
        }
